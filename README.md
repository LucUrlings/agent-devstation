...
A ready-to-run Docker development station for multiple projects. The Ubuntu 26.04 LTS image includes **Codex**, **Claude Code**, and **GitHub CLI (`gh`)**. Enable the browser editor to download code-server when needed. Select Python, Node.js, .NET, Java, Go, and Rust SDK versions through Compose. All tools see the same `/workspaces` tree and global SDK paths.
